  ...
  return (
    <article className="container px-4 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mt-3 font-heading text-4xl leading-tight text-neutral-900 md:text-6xl">{post.title}</h1>
        ...
        <div className="prose prose-neutral mt-8 max-w-none text-neutral-700">
          {post.content.map((paragraph) => (
            <p key={paragraph} className="mb-5 text-lg leading-relaxed">
              {paragraph}
            </p>
          ))}
        </div>

...
export const metadata: Metadata = {
    ...
    description:
        "Guides, inspiration, and insider perspectives for luxury travel in Southeast Asia.",
};
    ...
    return (
        <section className="container px-4 py-12">
            ...
            <p className="mt-3 max-w-2xl text-neutral-600">
                Practical planning tips, seasonal guidance, and curated
                inspiration from our travel specialists.
            </p>
                    ...
                    >
                        ...
                        <div className="p-5">
                            ...
                            <div className="mt-4 flex items-center gap-4 text-xs text-neutral-500">
                                ...
                                <span className="inline-flex items-center gap-1">
                                    <Clock3 size={13} /> {post.readingMinutes}{" "}
                                    min
                                </span>
                            </div>
                            <Link

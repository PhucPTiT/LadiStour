...
const slides = [
  {
    ...
    subtitle: "Tailor-made journeys through Vietnam, Laos, Cambodia, and Thailand.",
    image:
  ...
  },
  {
    ...
    subtitle: "From emerald bays to private coastline hideaways with concierge precision.",
    image:
  ...
  },
  {
    ...
    subtitle: "Elevated moments designed for travelers who value depth and comfort.",
    image:
      "https://images.unsplash.com/photo-1596534766419-6f8fe5f782c1?auto=format&fit=crop&w=1920&q=80",
    href: "/about",
  },
];
            ...
            <div className="relative h-[72vh] min-h-[540px] w-full">
              ...
              <div className="container relative flex h-full items-end px-4 pb-24">
                <div className="max-w-3xl text-white">
                  ...
                  <h1 className="font-heading text-4xl leading-tight md:text-6xl">{slide.title}</h1>
                  <p className="mt-4 max-w-2xl text-sm text-neutral-100 md:text-lg">{slide.subtitle}</p>
                  <Button asChild className="mt-8 rounded-full bg-[#be8a39] px-7 py-3 text-sm text-white hover:bg-[#a87932]">
        ...
        {slides.map((slide, index) => (
          <button
            ...
            className={`h-2.5 rounded-full transition-all ${
              current === index ? "w-8 bg-white" : "w-2.5 bg-white/55"
            }`}

            ...
            <div className="container relative px-4 text-white">
                <div className="max-w-3xl">
                    ...
                    <p className="mt-4 max-w-2xl text-sm leading-relaxed text-neutral-200 md:text-base">
                        Each itinerary is built around meaningful pacing and
                        local texture. Instead of rushing between landmarks, we
                        curate windows of time where design, cuisine, and
                        culture naturally unfold. This is why our journeys feel
                        less like packaged tours and more like thoughtful
                        narratives crafted around your travel style.
                    </p>
                </div>

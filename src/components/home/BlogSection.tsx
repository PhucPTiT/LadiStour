...
export default function BlogSection({ posts }: BlogSectionProps) {
  return (
    <section className="bg-[linear-gradient(180deg,#ffffff_0%,#f8f7f4_100%)] py-24" data-home-section>
      <div className="container px-4">
      <div className="mb-10 flex items-end justify-between gap-4">
        <div>
          <p className="text-xs font-semibold tracking-[0.2em] text-neutral-500 uppercase">Journal</p>
          <h2 className="mt-2 font-heading text-3xl text-neutral-900 md:text-5xl">Travel Notes & Insights</h2>
        </div>
        <Link href="/blog" className="text-sm font-semibold text-emerald-700">
          View all
        </Link>
      </div>
        ...
        {posts.map((post) => (
          ...
          >
            ...
            <CardContent className="p-5">
              ...
              <h3 className="mt-3 font-heading text-2xl text-neutral-900">{post.title}</h3>
